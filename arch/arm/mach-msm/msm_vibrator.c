...
/* [LGE_BSP_S] jihyun2.jang@lge.com, 20130504 - Vibrator won't work occasionally at ALT test. Reduced vibrator driving voltage by HW team request. */
//static int voltage_level = 2800;
static int voltage_level = 2600;
/* [LGE_BSP_E] jihyun2.jang@lge.com, 20130504 - Vibrator won't work occasionally at ALT test. Reduced vibrator driving voltage by HW team request. */
#else
#ifdef CONFIG_MACH_MSM7X27A_L4II_CDMA
static int voltage_level = 3100;
#else
