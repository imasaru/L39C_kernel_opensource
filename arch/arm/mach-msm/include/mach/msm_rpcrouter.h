...
#define ABSOLUTE_STRING_LENGTH  750 // 668 // 500 //40 [seypark@lge.com]
#define ABSOLUTE_EMMC_STRING_LENGTH  500 // 668 // 500 //40 [seypark@lge.com]
//#define ABSOLUTE_STRING_LENGTH  500 //40 [seypark@lge.com]
#define MAX_STRING_RET (ABSOLUTE_STRING_LENGTH/sizeof(AT_STR_t))
#define MAX_EMMC_STRING_RET (ABSOLUTE_EMMC_STRING_LENGTH/sizeof(AT_STR_t))
