...
/*LGE_CHANGE_S : 2013-04-17 sukkyoon.hong@lge.com  Imagis touch TA mode*/
...
/*LGE_CHANGE_S : 2013-04-17 sukkyoon.hong@lge.com  Imagis touch TA mode*/
#ifdef CONFIG_TOUCHSCREEN_IST30XX
		printk("[ TSP ] ist30xx_set_ta_mode value : 1\n");
...
/*LGE_CHANGE_S : 2013-04-17 sukkyoon.hong@lge.com  Imagis touch TA mode*/
#ifdef CONFIG_TOUCHSCREEN_IST30XX
		printk("[ TSP ] ist30xx_set_ta_mode value : 0\n");
...
static void usb_debugfs_init(struct usb_info *ui)
{
	...
	debugfs_create_file("release_wlocks", 0444, dent, ui,
						&debug_wlocks_ops);
	debugfs_create_file("prime_fail_countt", 0444, dent, ui,
						&prime_fail_ops);
	debugfs_create_file("proprietary_chg", 0444, dent, ui,
						&debug_prop_chg_ops);
}
#else
static void usb_debugfs_init(struct usb_info *ui) {}
