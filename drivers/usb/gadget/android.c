...
#if defined(CONFIG_LGE_USB_GADGET_DRIVER) && !defined(CONFIG_MACH_MSM7X27A_L4II_CDMA)
...
#else  // ifdef CONFIG_MACH_MSM7X27A_L4II_CDMA
	strlcpy(manufacturer_string, "LG Electronics, Inc",
		sizeof(manufacturer_string) - 1);
	strlcpy(product_string, "LG Android Phone", sizeof(product_string) - 1);
	strlcpy(serial_string, "0123456789ABCDEF", sizeof(serial_string) - 1);
#endif
