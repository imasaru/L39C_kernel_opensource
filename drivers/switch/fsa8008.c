...
/* LGE_CHANGE_S : 2013-03-25 hanul.jeong@lge.com [V1] To detect earjack when booting on earjack insert state by 56K cable */
#if defined(CONFIG_MACH_MSM7X25A_V1)
	/* LGE_CHANGE : bohyun.jung@lge.com 
	 * prevent kernel panic in case that remove isr comes before probe is done. */
	...
	s_bInitialized = true;
#endif
/* LGE_CHANGE_E : 2013-03-25 hanul.jeong@lge.com [V1] To detect earjack when booting on earjack insert state by 56K cable */
