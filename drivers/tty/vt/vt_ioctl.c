 ...
 * recent kernel 3.4 patch for suspend queue corruption, take kernel recent patch instead lge-workaround.
 * http://git.kernel.org/?p=linux/kernel/git/stable/linux-stable.git;a=commitdiff;h=a7b12929be6cc55eab2dac3330fa9f5984e12dda
 * Fix the race by ensuring we're registered for the event before we check if it's already completed.
 */
