...
/* LGE_CHANGE_S, L4II_CDMA [jaekyung83.lee@lge.com] 2013-05-14 GPU COMPOSITION */
#ifdef CONFIG_LGE_GPU_COMPOSITION_SUPPORT
#define MSM_RESERVE_AUDIO_SIZE		0x100000
#else
#define MSM_RESERVE_AUDIO_SIZE		0x1F4000
#endif
/* LGE_CHANGE_E, L4II_CDMA [jaekyung83.lee@lge.com] 2013-05-14 */
#ifdef CONFIG_ANDROID_RAM_CONSOLE
...
/* LGE_CHANGE_S, L4II_CDMA [jaekyung83.lee@lge.com] 2013-05-14 GPU COMPOSITION */
#ifdef CONFIG_LGE_GPU_COMPOSITION_SUPPORT
#define MSM_RESERVE_ADSP_SIZE      			0xD00000
#else
...
int get_usb_lock(void)
{
	...
	extern void lg_get_usb_access_lock_misc(void);
	extern void lg_set_usb_access_lock_misc(int value);

	if (lg_get_usb_lock_state()) {
		user_diag_enable = 1;
		lg_set_usb_access_lock_misc(1);
	}
	else {
		user_diag_enable = 0;
		lg_set_usb_access_lock_misc(0);
	}

#ifdef CONFIG_LG_FW_USB_ACCESS_LOCK_DEBUG
	lg_get_usb_access_lock_misc();
#endif
