...
#define FW_NAME_TOP_TOUCH			"mms_ts_top_touch.fw"
...
/* When Touch dualization */
	...
	{
		info->fw_name = kstrdup(FW_NAME_TOP_TOUCH, GFP_KERNEL);
        //printk(KERN_INFO"info - > fw_name : %s ", info->fw_name);
		dev_info(&client->dev, "ts_vendor : top_touch\n");
	}
