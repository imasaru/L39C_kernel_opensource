...
static void call_console_drivers(unsigned start, unsigned end)
{
	...
	while (cur_index != end) {
		if (msg_level < 0 && ((end - cur_index) > 2)) {
			 ...
			 * http://git.kernel.org/?p=linux/kernel/git/stable/linux-stable.git;a=commitdiff;h=ce0030c00f95cf9110d9cdcd41e901e1fb814417
			 * corrects a buffer overflow in kernels from 3.0 to 3.4 when calling log_prefix() function from calling_console_drivers()
			 */
