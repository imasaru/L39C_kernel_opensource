...
int wake_up_process(struct task_struct *p)
{
	 ...
	 * http://git.kernel.org/?p=linux/kernel/git/stable/linux-stable.git;a=commitdiff;h=465760c68a4e5037f10a7eab1df3fb2aff1e03a4
	 * wake_up_process() should never wakeup a TASK_STOPPED/TRACED task. change it to use TASK_NORMAL and add the WARN_ON()
	 */
