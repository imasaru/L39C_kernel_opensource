...
#if defined(CONFIG_MACH_MSM7X25A_M4)||defined(CONFIG_MACH_MSM7X25A_V3) ||defined(CONFIG_MACH_MSM8X25_V7) || defined(CONFIG_MACH_MSM7X25A_V1) || defined (CONFIG_MACH_MSM7X27A_L4II_CDMA)
...
#if defined(CONFIG_MACH_MSM7X27A_U0) || defined(CONFIG_MACH_MSM7X27A_L4II_CDMA)
        input_event(dev, EV_KEY, code, value);
#else
        input_event(dev, EV_KEY, code, !!value);
#endif
...
{
#if defined(CONFIG_MACH_MSM7X25A_M4) || defined (CONFIG_MACH_MSM7X27A_L4II_CDMA)
	if(LGF_TestModeGetDisableInputDevices())
		;
	else
#endif		
