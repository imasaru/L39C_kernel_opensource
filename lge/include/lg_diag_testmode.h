...
#define BOOTLOADER_UNLOCK_LENGTH 50

typedef enum
{
	BOOTLOADER_UNLOCK_READ,
	BOOTLOADER_UNLOCK_WRITE,
	BOOTLOADER_UNLOCK_GET_INFORMATION,	
	RCT,
} test_mode_req_rct_type;

typedef struct {
	char result[BOOTLOADER_UNLOCK_LENGTH];
} PACKED test_mode_rsp_rct_type;
...
#if defined(CONFIG_MACH_MSM7X27A_L4II_CDMA) || defined(CONFIG_MACH_MSM7X25A_V1)
	char lcd_get_kcal[10];
#endif
...
// +e LGBT_DIAG_BT_WIFI_FOR_MFT
    TEST_MODE_MINIOS_BOOTCHECK=142,
//LGE_CHANGE_S 2012.11 lg-msp@lge.com MTS TEAM
    TEST_MODE_MTS=143,
//LGE_CHANGE_E 2012.11 lg-msp@lge.com MTS TEAM
#if defined(CONFIG_LGE_RCT_41) 	/* bohyun.jung@lge.com	- RCT Porting 4.1 - Bootloader Unlock */
